...
public class CardController implements ICommonController<RespEntity<?>, CardParam, SearchParam, ModifyCardParam,String> {
    ...
    public RespEntity<?> insert(@RequestBody @Validated CardParam param) throws Throwable {
    ...
    public RespEntity<?> delete(String param) {
    ...
    public RespEntity<?> update(@RequestBody @Validated ModifyCardParam param) throws Throwable {
    ...
    public RespEntity<?> query(@RequestBody SearchParam param) throws CommonException {
