...
public class CommonPageRequestUtils {
    ...
    public static <T> Page<T> defaultPage() throws CommonException {
        return defaultPage(null);
    }

    public static <T> Page<T> defaultPage(List<OrderItem> orderItemList) throws CommonException {
     ...
     **/
    public static String getParamFromRequest(String paramName) throws CommonException {
    ...
    public static HttpServletRequest getRequest() throws CommonException {
    ...
    public static HttpServletResponse getResponse() throws CommonException {
        ServletRequestAttributes servletRequestAttributes;
        try {
            servletRequestAttributes = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();
        } catch (Exception e) {
