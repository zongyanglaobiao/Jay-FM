...
import {getRandomId, getRandomNumber, isArrayBlank, isNullOrUndefined} from "../../lib/common/util";
...
import {createAlertMsg, ERROR} from "../PromptBox/PromptBox";
							...
							(() => {
								return isNullOrUndefined(songs) ? <div>暂无歌曲</div>
									: isArrayBlank(songs) ? <div>暂无歌曲</div> : songs.map((item) => {
										const {songName,singer,downloadId} = item
										return (
											<div key={getRandomId()}
												 onClick={()=>{
													 ...
													 //修改音乐路径
													 audio.current.src = `http://xxl.cab/song/download?id=${downloadId}`
													 audio.current.play().catch(e => console.error("播放失败:", e));
												 }}
 ...
 * @constructor
 */
export const AudioContext = createContext("default value of audio context");
export default  memo(()=>{
			...
			<div className='music-player-container'>
				...
				<div className='music-player'>
					...
					<div className='music-player-box'>
						...
						<svg style={{transform: 'rotate(180deg)'}} t="1699195161909"
							 className="music-player-play-button" viewBox="0 0 1024 1024" version="1.1"
						...
						{
							isPlay ?
								<svg onClick={setPlay} t="1699195121351" className="music-player-play-button"
									 viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
									 p-id="1596" width="200" height="200">
									<path d="M121.3 680.4m-40.9 0a40.9 40.9 0 1 0 81.8 0 40.9 40.9 0 1 0-81.8 0Z"
										  fill="#242424" p-id="1597"></path>
									<path d="M266.5 855.6m-40.9 0a40.9 40.9 0 1 0 81.8 0 40.9 40.9 0 1 0-81.8 0Z"
										  fill="#242424" p-id="1598"></path>
									<path
									...
									<path
										...
										fill="#242424" p-id="1600"></path>
								</svg>
								:
								<svg onClick={setPlay} t="1699195095701" className="music-player-play-button"
									 viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
									 p-id="1449" width="200" height="200">
									<path d="M772.7 217.7a32.2 32.1 0 1 0 64.4 0 32.2 32.1 0 1 0-64.4 0Z" fill="#242424"
										  p-id="1450"></path>
									<path
									...
									<path
										...
										fill="#242424" p-id="1452"></path>
								</svg>
						}
						<svg t="1699195161909" className="music-player-play-button" viewBox="0 0 1024 1024"
							 version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1748" width="200" height="200">
							<path
								d="M744.727273 551.563636L325.818182 795.927273c-30.254545 18.618182-69.818182-4.654545-69.818182-39.563637v-488.727272c0-34.909091 39.563636-58.181818 69.818182-39.563637l418.909091 244.363637c30.254545 16.290909 30.254545 62.836364 0 79.127272z"
								p-id="1749"></path>
						</svg>
